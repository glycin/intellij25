...
object AttackConfig {
    ...
    val DRONE_WEAPON = AttackDef(
        ...
        upgrades = listOf(
            ...
            AttackUpgradeDef(
                title = "Full line autocompletion",
    ...
    val FIREWORK_WEAPON = AttackDef(
        ...
        unlockedByDefault = false,
        image = UpgradePNG.fireworkUnlock,
        availableAtLevel = 2,
        ...
        upgrades = listOf(
            AttackUpgradeDef(
                ...
                effect = "Upgrade the firework weapon by increasing the rate at which fireworks are fired.",
                availableAtLevel = 2,
            ...
            AttackUpgradeDef(
                ...
                effect = "Upgrade the firework weapon by adding an extra firework.",
                availableAtLevel = 3,
            ...
            AttackUpgradeDef(
                ...
                effect = "Upgrade the firework weapon to it's maximum by increasing the rate at which fireworks are fired and add two additional fireworks.",
                availableAtLevel = 3,
    ...
    val TOXIC_POOL_WEAPON = AttackDef(
    ...
    val LIGHTNING_STRIKE_WEAPON = AttackDef(
        ...
        unlockedByDefault = false,
        availableAtLevel = 2,
        image = UpgradePNG.lightningUnlock,
    ...
    val SIDE_SHOT_WEAPON = AttackDef(
    ...
    val FORCE_FIELD_WEAPON = AttackDef(
        ...
        unlockedByDefault = false,
        availableAtLevel = 1,
        image = UpgradePNG.forceFieldUnlock,
